...
@requires_admin
def admin_dashboard():
    """ This view will help admin know how books are there in library """
    books = Book.query.all()
    if books:
...
#Logout fucntion taken care by flask inbulit method
...
#Base Error message thrown for not logged in users
